    ...
    public class ScepterAttack : RangedWeapon
    {
        ...
        public override void CmdAttack()
        {
            ...
            if (CanAttack)
            {
                ...
                syncManager.CmdSpawnFireball(3,position,(baseDamage + damagePercent * User.abilityPower),anchor.transform.forward);
            }
        }
        [ClientRpc]
        public override void AttackRpc()
        {
            ...
            newFireball.GetComponent<Energyball>().attacker = User;
