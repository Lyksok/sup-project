...
namespace Abilities
{
    public class AbilityArrowRain_5 : Ability
    {
        ...
        public AbilityArrowRain_5(Rarities rarity,Entity target) //Sets the stats according to Rarity of the Ability
        {
            ...
            displayDesc = $"Causes arrows to rain from the sky at your cursor's location, dealing {damage} damage to all enemies hit. Has a {Cooldown} seconds cooldown.";
            Rarity = rarity;
            State = States.READY;
            Target = target;
            range = 9f;
            _explosion = Target.resources.projectileList[9];
